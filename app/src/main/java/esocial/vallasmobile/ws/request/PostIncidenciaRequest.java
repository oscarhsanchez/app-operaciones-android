...
public class PostIncidenciaRequest extends WsRequest {

    public PostIncidenciaRequest(VallasApplication context) {
        super(context);
    }

    public <T> T execute(Incidencia incidencia, Class<T> responseClass) {

        Gson gson = new Gson();
        String jSend = gson.toJson(incidencia);
        String eSend = "";
        try {
        ...
        return super.executePostDefaultHeaders(Constants.INCIDENCIAS, param, responseClass);
    }

 ...
 */
public class OrdenesPendientesFragment extends BaseFragment implements OrdenesListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.ordenes_pendientes, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((MainTabActivity)getActivity()).setOrdenesPendientesListener(this);
        ...
        new GetOrdenesTask(getActivity(), criteria,
                searchByLocation ? VallasApplication.currentLocation : null, "(0,1,3,4)",
                this);
    }
    ...
    private void loadOrdenes(){
        ...
        new GetOrdenesTask(getActivity(), criteria,
                searchByLocation ? VallasApplication.currentLocation : null, "(0,1,3,4)",
                OrdenesPendientesFragment.this);
    }
